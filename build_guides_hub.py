...
ARTICLES = [
    ...
    dict(slug="how-far-is-10000-steps", i18n={
        "": ("How far is 10,000 steps?",
             "About 7–8 km / 4.4–5 miles — tables by height, stride and pace."),
        "de": ("10.000 Schritte in km",
               "Rund 7–8 km — Umrechnungstabellen, Gehzeiten und deine eigene Schrittlänge."),
        "fr": ("10 000 pas en km : quelle distance ?",
               "Environ 7 à 8 km — tableaux de conversion, temps de marche et foulée."),
        "es": ("¿Cuántos kilómetros son 10.000 pasos?",
               "Unos 7–8 km (4,4–5 millas). Tablas por pasos y estatura, y tu zancada."),
        "ja": ("1万歩は何キロ？距離と時間",
               "ほとんどの成人でおよそ7〜8km。歩数別・身長別の換算表と歩幅の測り方。"),
        "pt-br": ("Quantos km são 10.000 passos?",
                  "Cerca de 7,5 km — tabelas por altura e como medir sua própria passada."),
        "ru": ("10 000 шагов — это сколько километров?",
               "Примерно 7–8 км. Таблицы перевода в км и мили, по росту, и время ходьбы."),
        "uk": ("10 000 кроків — це скільки кілометрів?",
               "Таблиці км і миль, кроки на кілометр, час ходьби та як виміряти свій крок."),
    }),
    dict(slug="pixel-islands-vs-pikmin-bloom", i18n={
        "": ("Pixel Islands vs Pikmin Bloom",
             "Two walking games, opposite philosophies — honestly compared."),
        "de": ("Pixel Islands vs. Pikmin Bloom",
               "Zwei Walking-Games, ehrlich verglichen — GPS, Akku, Social, Druck."),
        "fr": ("Pixel Islands vs Pikmin Bloom",
               "Comparaison honnête : GPS, batterie, social, pression — et lequel choisir."),
        "es": ("Pixel Islands vs Pikmin Bloom",
               "Dos juegos de caminar en extremos opuestos, comparados con honestidad."),
        "ja": ("ピクミン ブルームと徹底比較",
               "開発チームが正直に比較。GPS・バッテリー・プレッシャーの有無で選ぶ。"),
        "pt-br": ("Pixel Islands vs Pikmin Bloom",
                  "Comparação honesta: GPS, bateria, social e pressão — qual combina com você."),
        "ru": ("Pixel Islands vs Pikmin Bloom",
               "Честное сравнение от нашей команды: GPS, батарея, давление — и что выбрать."),
        "uk": ("Pixel Islands чи Pikmin Bloom?",
               "Чесне порівняння від нашої команди: GPS, батарея, соціальність і тиск."),
    }),
